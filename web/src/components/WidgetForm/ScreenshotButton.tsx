...
export function ScreenshotButton({
  ...
  return (
    <button
      ...
      className='bg-zinc-800 p-2 rounded-md border-transparent hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors '
    >
