    ...
    <>
      ...
      <div className='flex flex-col items-center py-10 w-[304px]'>
        ...
        <button
          ...
          className='py-2 px-6 flex text-sm leading-6 justify-center mt-6 rounded-md border-transparent bg-zinc-800 hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors'
        >
          Quero enviar outro
        </button>
      </div>
